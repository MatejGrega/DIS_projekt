...
#define AU_PA_CTRL_PIN_NUM  GPIO_NUM_10
...
static esp_err_t es8311_codec_init(void){
    ...
    ESP_RETURN_ON_ERROR(es8311_microphone_gain_set(es_handle, AUDIO_MIC_GAIN), TAG, "set es8311 microphone gain failed");
...
void hw_init_audio(i2s_chan_handle_t *tx_handle, i2s_chan_handle_t *rx_handle){
    // Configure the speaker amplifier enable GPIO
